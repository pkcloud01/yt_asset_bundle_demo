# yt_asset_bundle_demo_project

The 'yt_asset_bundle_demo_project' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] yt_asset_bundle_demo_project_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/yt_asset_bundle_demo_project.job.yml). The schedule
